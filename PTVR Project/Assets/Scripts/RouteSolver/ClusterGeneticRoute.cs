...
namespace RouteSolver
{
    class ClusterGeneticRoute
    {
        ...
        List<int> CreateSegment(ClusterGeneticRoute father, System.Random r)
        {
        ...
        void PrintBreeding(ClusterGeneticRoute mother, ClusterGeneticRoute father, int startGene, int endGene, string segmentLog)
        {
